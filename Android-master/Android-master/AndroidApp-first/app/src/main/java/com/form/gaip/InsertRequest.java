...
public class InsertRequest extends StringRequest{
    ...
    final static private String URL = "https://pcbangq.000webhostapp.com/pc_myPc.php";
    private Map<String, String> parameters;
    public InsertRequest(String Id,String name, Response.Listener<String> listener){
