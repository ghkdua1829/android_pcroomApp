...
public class TimeRequest extends StringRequest {
    ...
    final static private String URL = "https://pcbangq.000webhostapp.com/pc_time.php";

    private Map<String, String> parameters;

    //생성자
    public TimeRequest(String userID,String userTime,String seat_num,String pcname, Response.Listener<String> listener){
